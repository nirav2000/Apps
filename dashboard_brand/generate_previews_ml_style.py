...
def dashboard_art() -> str:
    ...
    <rect x="84" y="258" width="1032" height="2" fill="#8dc1ff" opacity="0.35">
      <animate attributeName="y" values="258;652;258" dur="5.8s" repeatCount="indefinite"/>
    </rect>
    '''
...
def build_svg(entry: dict) -> str:
  ...
  <rect x="80" y="160" width="1040" height="560" rx="28" fill="none" stroke="rgba(255,255,255,0.16)"/>
  <rect x="0" y="0" width="280" height="760" fill="url(#scan)">
    <animate attributeName="x" values="-320;1280" dur="4.8s" repeatCount="indefinite"/>
  </rect>
